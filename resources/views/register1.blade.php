...
<div class="container">
 <form action="/regp2" method="get">
        <h3>REGISTER for <?php echo "$result"; ?></h3><br>
        <div class="form-row">
        ...
        <div class="form-row">
            <label for="category" class="col-12 col-sm-2 col-form-label">PROFILE</label>
            <div class="col-12 col-sm-3">
                <input type="text" class="form-control" name="company" value=" <?php echo $profile ?> " readonly/>
            </div> 
        </div><br>

        <div class="form-row">
            <div class="offset-sm-2"></div>
                <button class="btn btn-primary" type="">Next</button>
        </div>
